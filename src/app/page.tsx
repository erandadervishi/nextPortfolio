...
const boxCard =
  "box-card box-content p-16 bg-white absolute left-1/2 w-full gap-12 -top-60 transform -translate-x-1/2 rounded-xl shadow-md  my-0 m-auto max-w-screen-xl flex align-center";
