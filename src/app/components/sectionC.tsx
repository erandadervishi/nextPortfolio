      ...
      <div id="process" className="bg-[#f5f5f5] py-36 px-0">
        <div className="my-0 m-auto max-w-screen-xl flex gap-8 items-center">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-[#fff] p-6 rounded-2xl hover:shadow-xl odd:relative odd:-top-6">
              <FontAwesomeIcon
                icon={faBook}
                className="w-6 text-[#a53dff] text-3xl mb-4"
              />
              <h5 className="text-[#000] text-xl font-bold my-2.5 mx-0 ">
                1.Research
              </h5>
              <p>
