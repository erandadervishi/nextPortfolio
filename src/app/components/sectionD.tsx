      ...
      <div id="portfolio" className="py-20 px-0">
        <div className="my-0 m-auto max-w-screen-xl">
          <div className="mb-20 text-center">
            <h2 className="pb-2 text-4xl font-bold text-black mb-2">
              Portfolio
            </h2>
            <p>
          ...
          <div className="grid grid-cols-3 gap-4 mb-12">
            <div className="rounded-2xl border-2 border-solid border-[#ddd] hover:shadow-2xl">
              ...
              <div className="p-4">
                <p>HTML-CSS DESIGN</p>
                <h4 className="text-2xl font-bold text-black my-2">
          ...
          <button className={`${btnClass} + my-0 mx-auto block`}>
            More Projects
          </button>
        </div>
      </div>
